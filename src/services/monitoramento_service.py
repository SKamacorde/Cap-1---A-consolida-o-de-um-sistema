...
class MonitoramentoService:
    ...
    def inserir_monitoramento(self, cd_cultura_produto_sensor, vlr_medido, dt_medicao, cd_usuario_inclusao):
        ...
        # Inserir dados
        monitoramento = Monitoramento(cd_monitoramento=None, cd_cultura_produto_sensor= cd_cultura_produto_sensor, vlr_medido =vlr_medido, dt_medicao = dt_medicao, 
        ...
        if vlr_medido < configuracao.vlr_minimo:
            valor_aplicado =   configuracao.vlr_minimo - vlr_medido

        # Inserir aplicação
        self.aplicacao_service.inserir_aplicacao(cd_monitoramento,vlr_medido,configuracao.vlr_minimo,configuracao.vlr_maximo,valor_aplicado,cd_usuario_inclusao)
    ...
    def listar_monitoramentos(self):
        monitoramentos =  self.monitoramento_repository.listar_todos()  
