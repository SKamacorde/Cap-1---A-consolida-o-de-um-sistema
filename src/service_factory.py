...
from src.services.meteorologia_service import MeteorologiaService
...
def get_monitoramento_service():
    ...
    aplicacao_service = get_aplicacao_service()  # Agora passamos a dependência aqui
...
def get_meteorologia_service():
    return MeteorologiaService()

def get_irrigacao_service():
    meteorologia_service = get_meteorologia_service()  # Agora passamos a dependência aqui
    return IrrigacaoService(meteorologia_service)
